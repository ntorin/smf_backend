...
RSpec.describe FollowsController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all follows as @follows" do
      ...
      expect(assigns(:follows)).to eq([follow])
    end
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested follow" do
        follow = Follow.create! valid_attributes
        put :update, {:id => follow.to_param, :follow => new_attributes}, valid_session
        follow.reload
    ...
    describe "with invalid params" do
      it "assigns the follow as @follow" do
        follow = Follow.create! valid_attributes
        put :update, {:id => follow.to_param, :follow => invalid_attributes}, valid_session
        expect(assigns(:follow)).to eq(follow)
      end
