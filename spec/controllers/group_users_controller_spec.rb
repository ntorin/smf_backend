...
RSpec.describe GroupUsersController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all group_users as @group_users" do
      ...
      expect(assigns(:group_users)).to eq([group_user])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested group_user as @group_user" do
      ...
      expect(assigns(:group_user)).to eq(group_user)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created group_user as @group_user" do
        post :create, {:group_user => valid_attributes}, valid_session
        expect(assigns(:group_user)).to be_a(GroupUser)
        expect(assigns(:group_user)).to be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved group_user as @group_user" do
        post :create, {:group_user => invalid_attributes}, valid_session
        expect(assigns(:group_user)).to be_a_new(GroupUser)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested group_user" do
        group_user = GroupUser.create! valid_attributes
        put :update, {:id => group_user.to_param, :group_user => new_attributes}, valid_session
        group_user.reload
    ...
    describe "with invalid params" do
      it "assigns the group_user as @group_user" do
        group_user = GroupUser.create! valid_attributes
        put :update, {:id => group_user.to_param, :group_user => invalid_attributes}, valid_session
        expect(assigns(:group_user)).to eq(group_user)
      end
