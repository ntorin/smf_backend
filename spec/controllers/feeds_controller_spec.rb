  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved feed as @feed" do
        post :create, {:feed => invalid_attributes}, valid_session
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested feed" do
        feed = Feed.create! valid_attributes
        put :update, {:id => feed.to_param, :feed => new_attributes}, valid_session
        feed.reload
    ...
    describe "with invalid params" do
      it "assigns the feed as @feed" do
        feed = Feed.create! valid_attributes
        put :update, {:id => feed.to_param, :feed => invalid_attributes}, valid_session
        expect(assigns(:feed)).to eq(feed)
      end
